...
import org.spacehq.mc.protocol.data.game.UnlockRecipesAction;
import org.spacehq.mc.protocol.data.game.advancement.Advancement;
...
import org.spacehq.mc.protocol.data.game.entity.FeetOrEyes;
...
import org.spacehq.mc.protocol.data.game.entity.metadata.Pose;
...
import org.spacehq.mc.protocol.data.game.window.AdvancementTabAction;
import org.spacehq.mc.protocol.data.game.window.ClickItemParam;
import org.spacehq.mc.protocol.data.game.window.CraftingBookDataType;
...
import org.spacehq.mc.protocol.data.game.window.UpdateStructureBlockAction;
import org.spacehq.mc.protocol.data.game.window.UpdateStructureBlockMode;
...
import org.spacehq.mc.protocol.data.game.world.block.CommandBlockMode;
import org.spacehq.mc.protocol.data.game.world.block.StructureMirror;
import org.spacehq.mc.protocol.data.game.world.block.StructureRotation;
import org.spacehq.mc.protocol.data.game.world.block.UpdatedTileType;
import org.spacehq.mc.protocol.data.game.world.block.value.*;
...
import org.spacehq.mc.protocol.data.game.world.particle.ParticleType;
...
public class MagicValues {
    ...
    static {
        ...
        register(MobType.DRAGON_FIREBALL, 14);
        register(MobType.DROWNED, 15);
        register(MobType.ELDER_GUARDIAN, 16);
        register(MobType.END_CRYSTAL, 17);
        register(MobType.ENDER_DRAGON, 18);
        register(MobType.ENDERMAN, 19);
        register(MobType.ENDERMITE, 20);
        register(MobType.EVOKER_FANGS, 21);
        register(MobType.EVOKER, 22);
        register(MobType.EXPERIENCE_ORB, 23);
        register(MobType.EYE_OF_ENDER, 24);
        register(MobType.FALLING_BLOCK, 25);
        register(MobType.FIREWORK_ROCKET, 26);
        ...
        register(MobType.ITEM, 34);
        register(MobType.ITEM_FRAME, 35);
        register(MobType.FIREBALL, 36);
        register(MobType.LEASH_KNOT, 37);
        register(MobType.LLAMA, 38);
        register(MobType.LLAMA_SPIT, 39);
        register(MobType.MAGMA_CUBE, 40);
        register(MobType.MINECART, 41);
        register(MobType.MINECART_CHEST, 42);
        register(MobType.MINECART_COMMAND_BLOCK, 43);
        register(MobType.MINECART_FURNACE, 44);
        register(MobType.MINECART_HOPPER, 45);
        register(MobType.MINECART_SPAWNER, 46);
        register(MobType.MINECART_TNT, 47);
        ...
        register(MobType.FISHING_BOBBER, 101);
